...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/howto/flexsearch.min.js');loadScript('/howto/en.search-data.min.0b5992ddb3738c781713a26507e49f2f45b0cad100d816a795bc641ee735050a.js',function(){input.required=false;search();});}
