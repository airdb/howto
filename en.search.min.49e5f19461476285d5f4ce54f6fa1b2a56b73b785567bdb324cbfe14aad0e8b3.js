...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/howto/flexsearch.min.js');loadScript('/howto/en.search-data.min.89d83658e8baf5146f74be273870bedaa24dbe33fc0edba90dd777e4d198b593.js',function(){input.required=false;search();});}
