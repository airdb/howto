...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/howto/flexsearch.min.js');loadScript('/howto/en.search-data.min.e56fc98bd66179c434a5d493f6e90ca77bacb4e2d7cf699eec1cf071d0784edd.js',function(){input.required=false;search();});}
