...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/howto/flexsearch.min.js');loadScript('/howto/en.search-data.min.15d5be6a1bb08d967360c749af34cd83bc62163f89ce3bd868400b149023bcca.js',function(){input.required=false;search();});}
