...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/howto/flexsearch.min.js');loadScript('/howto/en.search-data.min.2c9e091ebfb0eeed7555360789ad102e8d04850d8b635313fb9430c35f9751a1.js',function(){input.required=false;search();});}
