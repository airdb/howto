...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/howto/flexsearch.min.js');loadScript('/howto/en.search-data.min.2da4092d059a2c527d9e31dc3e961601dc26546234576a3d05f620e9e957b997.js',function(){input.required=false;search();});}
