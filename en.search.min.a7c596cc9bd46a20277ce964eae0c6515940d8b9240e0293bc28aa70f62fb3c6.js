...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/howto/flexsearch.min.js');loadScript('/howto/en.search-data.min.6a7d9de503e146d16fe69c9591a14d54ac41a145d68bda0bbc9dfb810e2f50cb.js',function(){input.required=false;search();});}
