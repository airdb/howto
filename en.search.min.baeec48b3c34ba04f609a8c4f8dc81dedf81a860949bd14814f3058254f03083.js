...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/howto/flexsearch.min.js');loadScript('/howto/en.search-data.min.691fa2b3531e9cec6f23dcab7a8a80aec74c1204379aeffbaaeaca4a29d5c712.js',function(){input.required=false;search();});}
