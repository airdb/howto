...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/howto/flexsearch.min.js');loadScript('/howto/en.search-data.min.9255aa079bd19346e0f4e4343f9b36cad72c7c5024520f64f65a8a4f599603c9.js',function(){input.required=false;search();});}
