...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/howto/flexsearch.min.js');loadScript('/howto/en.search-data.min.542651f58a739fd5f12a21b9025c69d7eee1c09a8bce562028d2b80de2cacc06.js',function(){input.required=false;search();});}
