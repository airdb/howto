...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/howto/flexsearch.min.js');loadScript('/howto/en.search-data.min.11038e56e158e4d0c86aa597bcde75bcc9dc434c8a9ff4db8ada6e35593367d9.js',function(){input.required=false;search();});}
